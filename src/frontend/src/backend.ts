...
export class Backend implements backendInterface {
    ...
    async getAllOrders(): Promise<Array<OrderRequest>> {
        if (this.processError) {
            try {
    ...
    async makeReservation(arg0: string, arg1: Reservation): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.makeReservation(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: string, arg1: OrderRequest): Promise<void> {
        if (this.processError) {
            try {
